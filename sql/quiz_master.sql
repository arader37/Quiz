...
(223, 'PHP', 'PHP variable start with which symbol?', '$', '&', '!', '#', '$', 'Images/PHP/phparray1.png'),
(224, 'PHP', 'What is correct way to open file "data.ext" as readable?', 'open("time.txt");', 'open("time.txt","read");', 'fopen("time.txt","r");', 'fopen("time.txt","r+");', 'fopen("time.txt","r+");', 'Images/PHP/phparray1.png'),
(225, 'PHP', 'What is the superglobal variable holds information about headers, paths, and script locations?', '$_SESSION', '$_GLOBALS', '$_SERVER', '$_GET', '$_SERVER', 'Images/PHP/phparray1.png'),
(226, 'PHP', 'when you want to check if two values are equal and of same data type. Which operator to use?', '!=', '=', '===', '==', '===', 'Images/PHP/phparray1.png');

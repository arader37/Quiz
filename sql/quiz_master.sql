...
(21, 'Costumes', 'What dress is this?', 'Saree', 'Lehenga Choli', 'Kurta Pajama', 'Salwar Kameez', 'Lehenga Choli', 'Images/dresses/lehenga_choli.jpg'),
(22, 'Costumes', 'What dress is this?', 'Kurta Pajama', 'Suit', 'Saree', 'Phiran', 'Saree', 'Images/dresses/saree.jpg'),
(23, 'Costumes', 'Which Indian state is this outfit from?', 'Goa', 'Bihar', 'Jharkhand', 'Meghalaya', 'Meghalaya', 'Images/dresses/meghalaya.jpg'),
(24, 'Costumes', 'What dress is this?', 'Suit', 'Saree', 'Dhoti', 'Kurta Pajama', 'Dhoti', 'Images/dresses/suit.jpg'),
(25, 'Costumes', 'What dress is this?', 'Jeans', 'Kurta Pajama', 'Dhoti', 'Saree', 'Kurta Pajama', 'Images/dresses/kurta_pajama.jpg'),
(26, 'Costumes', 'What dress is this?', 'Saree', 'Ghagra', 'Churidar Suit', 'Dhoti Kurta', 'Churidar Suit', 'Images/dresses/churidar_suit.jpg'),
(27, 'Costumes', 'A common outfit worn by women in Rajasthan is:', 'Ghagra Choli', 'Saree', 'Kurta', 'Lugda', 'Ghagra Choli', 'Images/dresses/ghagra_choli.jpg'),
(28, 'Costumes', 'A common outfit worn by men in Andhra Pradesh and ', 'Salwar Kameez', 'Dhoti Kurta', 'Alungsta', 'Lehenga Choli', 'Dhoti Kurta', 'Images/dresses/dhoti.jpg'),
(29, 'Costumes', 'Another name used in Gujarat for the lehenga choli', 'Ghagra Choli', 'Lehenga Choli', 'Chaniya Choli', 'Lehenga Voni', 'Chaniya Choli', 'Images/dresses/chaniya_choli.jpg'),
(30, 'Costumes', 'What color is generally worn on Holi?', 'red', 'purple', 'white', 'orange', 'white', 'Images/dresses/white.jpg'),
(31, 'Costumes', 'Which Indian state is this outfit from?', 'West Bengal', 'Bangladesh', 'Gujarat', 'Uttar Pradesh', 'Gujarat', 'Images/dresses/gujarat.jpg'),
(32, 'Costumes', 'Which Indian state is this outfit from?', 'Haryana', 'Punjab', 'Assam', 'Madhya Pradesh', 'Assam', 'Images/dresses/assam.jpg'),
(33, 'Costumes', 'Which Indian state is this outfit from?', 'Karnataka', 'Nagaland', 'Gujarat', 'Rajasthan', 'Nagaland', 'Images/dresses/nagaland.jpg'),
(34, 'Costumes', 'Which Indian state is this outfit from?', 'Goa', 'Manipur', 'Uttar Pradesh', 'Tamil Nadu', 'Manipur', 'Images/dresses/manipur.jpg'),
(35, 'Costumes', 'Which Indian state is this outfit from?', 'Bihar', 'Mizoram', 'Andhra Pradesh', 'Madhya Pradesh', 'Mizoram', 'Images/dresses/mizoram.jpg'),
(36, 'Costumes', 'Which Indian state is this outfit from?', 'Meghalaya', 'Maharashtra', 'Tripura', 'Kerala', 'Maharashtra', 'Images/dresses/maharashtra.jpg'),
(37, 'Costumes', 'A common outfit worn by women in Punjab is:', 'Dhoti', 'Phulkari Dupatta', 'Suit', 'Patiala Salwar', 'Patiala Salwar', 'Images/dresses/patiala_salwar.jpg'),
(38, 'Costumes', 'A common type of headgear worn by men in Punjab is', 'Baseball Cap', 'Headband', 'Winter Hat', 'Dastar', 'Dastar', 'Images/dresses/dastar.jpg'),
(39, 'Costumes', 'During which time period did saree become the trad', 'The Vedic Age', 'The Epic Age', 'The Gupta Era', 'The Chola Empire', 'The Vedic Age', 'Images/dresses/vedic.jpg'),
(40, 'Costumes', 'What color does the bride generally wear in an Ind', 'Red', 'Orange', 'White', 'Yellow', 'Red', 'Images/dresses/red.jpg'),
